  ...
  const issues = await Promise.all([
    prisma.issue.create({
      data: {
        ...
        description: 'Payment processing fails for international transactions. Need to investigate and fix urgently.',
        priority: 'CRITICAL',
        status: 'OPEN',
        reporterId: admin.id,
        ...
        raisedDate: new Date('2024-02-20'),
        expectedEndDate: new Date('2024-02-25'),
        tags: 'urgent, payment, bug'
      },
    }),
    prisma.issue.create({
      data: {
        title: 'UI design review needed',
        description: 'The mobile app design needs review for consistency with brand guidelines.',
        priority: 'MEDIUM',
        status: 'IN_REVIEW',
        ...
        roleLevel: 'EMPLOYEE',
        projectId: projects[0].id,
        raisedDate: new Date('2024-02-18'),
    ...
    prisma.issue.create({
      data: {
        ...
        description: 'Database queries are running slow. Need to optimize indexes and query structure.',
        priority: 'HIGH',
        status: 'OPEN',
        ...
        roleLevel: 'EMPLOYEE',
        projectId: projects[3].id,
        raisedDate: new Date('2024-02-19'),
        expectedEndDate: new Date('2024-03-05'),
    ...
    prisma.issue.create({
      data: {
        ...
        description: 'The REST API endpoints are not properly documented. Need comprehensive documentation.',
        priority: 'LOW',
        ...
        roleLevel: 'EMPLOYEE',
        projectId: projects[2].id,
        raisedDate: new Date('2024-02-15'),
        expectedEndDate: new Date('2024-03-10'),
        tags: 'documentation, api'
      },
    }),
    prisma.issue.create({
      data: {
        title: 'Security vulnerability in login system',
        description: 'Potential security issue detected in authentication flow. Immediate attention required.',
        priority: 'CRITICAL',
        status: 'ESCALATED',
        reporterId: users[2].id,
        assignedTo: admin.id,
        ...
        projectId: projects[4].id,
        raisedDate: new Date('2024-02-17'),
        expectedEndDate: new Date('2024-02-22'),
    ...
    prisma.issue.create({
      data: {
        ...
        description: 'Application crashes when launched on iOS 17 devices. Need compatibility fix.',
        priority: 'HIGH',
        status: 'RESOLVED',
        ...
        roleLevel: 'TEAM_LEAD',
        projectId: projects[1].id,
        raisedDate: new Date('2024-02-10'),
        expectedEndDate: new Date('2024-02-20'),
    ...
    prisma.issue.create({
      data: {
        ...
        description: 'Users are requesting dark mode support for better user experience.',
        priority: 'MEDIUM',
        status: 'OPEN',
        reporterId: admin.id,
        assignedTo: users[1].id,
        roleLevel: 'EMPLOYEE',
        projectId: projects[0].id,
        raisedDate: new Date('2024-02-21'),
    ...
    prisma.issue.create({
      data: {
        ...
        description: 'Email notification system is not sending emails to users. Need to fix SMTP configuration.',
        priority: 'HIGH',
        status: 'OPEN',
        reporterId: users[0].id,
        assignedTo: null,
        roleLevel: 'TEAM_LEAD',
        projectId: projects[3].id,
        raisedDate: new Date('2024-02-22'),
        expectedEndDate: new Date('2024-02-26'),
        tags: 'email, notification, bug'
      },
    }),
  ]);

  console.log('Created issues:', issues.length);
