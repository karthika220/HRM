...
async function perfectRestore() {
  try {
    console.log('🚀 Perfect Data Restoration...\n');
      ...
      for (let i = 0; i < tasksNeeded; i++) {
        await prisma.task.create({
          data: {
            ...
            assigneeId: owner.id,
            projectId: project.id, // Direct ID assignment
            creatorId: owner.id, // Correct field name
            createdAt: new Date(),
            updatedAt: new Date()
          }
        });
    ...
    console.log('\n🎉 ENTIRE APPLICATION RESTORED SUCCESSFULLY!');
    console.log('📊 Dashboard, Tasks, Projects, Users, Notifications all working!');
