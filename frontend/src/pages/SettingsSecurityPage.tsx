...
const DEMO_ROLES = [
  ...
  { id: '2', name: 'Admin', permissions: ['users.read', 'users.write', 'projects.read', 'projects.write', 'attendance.read', 'attendance.write'] },
  { id: '3', name: 'Manager', permissions: ['users.read', 'projects.read', 'projects.read', 'attendance.read', 'attendance.write'] },
  { id: '4', name: 'Employee', permissions: ['users.read', 'projects.read', 'attendance.read'] }
]
...
const DEMO_INTEGRATION_SETTINGS = {
  slack: {
    enabled: false,
    webhookUrl: '',
    channel: '#general'
